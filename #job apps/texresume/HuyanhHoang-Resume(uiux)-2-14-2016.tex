...
\cventry{February 2016}{TreeHacks}{Stanford}{}{Procrastinationation}{\begin{itemize}
		\item Collaborated with a multi-disciplinary team to create a Google Chrome extension that keeps track of spent time in specific pages of a browser and visually displays that information
...
\cventry{November 2015}{HackUCI}{UCI}{}{Unavoidable}{\begin{itemize}
	...
	\end{itemize}}
\cventry{November 2015}{MedAppJam}{UCI}{}{Medthodical}{\begin{itemize}
...
\cvlistitem{Familiar with Sketch, Adobe Photoshop, Unified Modeling Language, Swift and Xcode, Java, HTML/CSS}
