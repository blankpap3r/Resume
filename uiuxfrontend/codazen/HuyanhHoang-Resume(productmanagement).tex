...
\cventry{January 2016--Present}{Development Intern}{Rohm}{Irvine}{}{\begin{itemize}
		\item Implemented additional APIs for an iOS platform dealing with event coordination and event discovery
...
\cventry{January 2016--March 2016}{The Use of Cellphones in the Student Worker Environment}{UCI}{Irvine}{}{\begin{itemize}
		\item Investigated the nuances and implications of students being able to use their smartphone on shift in the university level student worker environment, totaling 10 hours of observations
		\item Interviewed clients to establish rapport in order to conduct observations
		\item Constructed a portfolio analyzing on the relationship between the university student center and its information systems in regards to the observations
	\end{itemize}}
...
%		\item Implemented a console-based implementation of Connect Four and Othello using Python
...
\cventry{June 2013}{Eagle Scout Project}{Boy Scouts of America}{Westminster}{}{\begin{itemize}
	...
	\end{itemize}}
\section{Skills}
\cvlistitem{Proficiency in object-oriented programming with Python and Swift}
\cvlistitem{Practical knowledge of HTML, CSS, Xcode, Cocoa, git, Sketch, Balsalmiq, Unified Modeling Language, User Experience Design}
\cvlistitem{Experience with technical writing}
%\section{References}
%\begin{cvcolumns}
