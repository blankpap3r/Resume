...
\section{Experience}
\cventry{January 2016--Present}{iOS Developer}{Rohm}{Irvine}{}{\begin{itemize}
		...
		\item Construct documentation detailing a high-level overview of the code structure for later implementation in the Android version
	\end{itemize}}
...
\cventry{June 2013}{Eagle Scout Project}{Boy Scouts of America}{Westminster}{}{\begin{itemize}
	...
	\end{itemize}}
\section{Skills}
\cvlistitem{Proficiency in object-oriented programming with Python, Java, C++, and Swift, SQL databases}
