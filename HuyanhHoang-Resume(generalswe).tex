...
\cventry{January 2016--Present}{Cofounder}{Rohm}{Irvine}{}{\begin{itemize}
		\item Convert prototypes for an iOS platform dealing with event coordination and event discovery to Swift code using Firebase and UIKit as well as external libraries
...
\cventry{June 2013}{Eagle Scout Project}{Boy Scouts of America}{Westminster}{}{\begin{itemize}
	...
	\end{itemize}}
\section{Skills}
\cvlistitem{Excellent in implementation skills and algorithms with C++, Java, Python, and Swift}
