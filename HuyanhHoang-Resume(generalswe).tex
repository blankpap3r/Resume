...
\cventry{June 2013}{Eagle Scout Project}{Boy Scouts of America}{Westminster}{}{\begin{itemize}
	...
	\end{itemize}}
\section{Skills}
\cvlistitem{Proficiency in object-oriented programming with Python}
\cvlistitem{Familiar with Sketch, Balsalmiq, Adobe Photoshop, Unified Modeling Language, Swift and Xcode, HTML and CSS, git, Javascript, Technical writing, User experience design}
\cvlistitem{Basic knowledge of C\# and Unity, Linux/UNIX, Java, D3}
%\section{References}
%\begin{cvcolumns}
