...
\cventry{July 2016--Present}{Independent Developer}{CalorieUI}{Irvine}{}{\begin{itemize}
		\item Developing a fitness utility iOS application that tracks calories and automatically counts the workout set repetitions
...
\cvlistitem{Familiar with Cocoa API, Unified Modeling Language, HTML5/CSS3, Sketch, D3, MongoDB, Node.js, JavaScript, SQL}
%\section{References}
%\begin{cvcolumns}
