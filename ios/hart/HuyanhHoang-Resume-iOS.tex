...
\cvlistitem{Familiar with Xcode/Cocoa, Unified Modeling Language, HTML5/CSS3, Sketch}
\cvlistitem{Basic knowledge of C\# and Unity, Linux/UNIX, D3, SQL, Java, JavaScript}
%\section{References}
%\begin{cvcolumns}
